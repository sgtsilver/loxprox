...
Deploy: ein Script (`deploy.sh`, ~3000 Zeilen, idempotent). Validierung: 50+ automatisierte Checks. Note: A- über CIS Debian 12, OWASP Top 10 und OWASP IoT Top 10.
...
- Idempotentes Deploy-Script mit ~3000 Zeilen
