...
Deploy: one script (`deploy.sh`, ~3000 lines, idempotent). Validate: 50+ automated checks. Grade: A- across CIS Debian 12, OWASP Top 10, and OWASP IoT Top 10.
...
- Idempotent ~3000-line deployment script
